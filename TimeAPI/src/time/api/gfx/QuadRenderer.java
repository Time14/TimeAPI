...
public class QuadRenderer extends Renderer {
	...
	public QuadRenderer(float x, float y, float width, float height, Texture texture) {
		setMesh(new Mesh(new VertexTex[]{
				...
				new VertexTex(new Vector3f(0, height, 0), new Vector2f(0, 1)),
				new VertexTex(new Vector3f(width, height, 0), new Vector2f(1, 1)),
				new VertexTex(new Vector3f(width, 0, 0), new Vector2f(1, 0))
		}, 0, 1, 2, 0, 2, 3));
